<template>
  ...
  >
    <g>
      <path
        d="M25.874,19.225c-0.645-1.431-4.575-2.669-4.575-2.669c-2.096-0.739-2.11-1.477-2.11-1.477
    ...
    c6.792,0.143,11.735-1.929,11.735-1.929c0.717-0.452,0.738-0.811,0.738-0.811C28.019,24.11,25.874,19.225,25.874,19.225z"
      />
      <path
        d="M10.898,10.786c0.315,2.612,2.563,5.32,4.603,5.32c2.344,0,4.572-2.846,4.919-5.32c0.132-0.094,0.349-0.321,0.428-0.837
...
<script lang="ts">
/**
 * @module components/Icons/MaleIcon
 * @description Gender-specific SVG icon showing a stylized male silhouette.
 */
export default {
  name: 'MaleIcon',
}
